...
description: "Optimize your Odds-API.io integration with best practices for caching, batch requests, error handling, and rate limiting. Build efficient apps."
---
...
const response = await fetch(
  `https://api2.odds-api.io/v3/events?apiKey=${apiKey}&sport=football&bookmaker=Bet365`
);
