...
<Steps>
  <Step title="Sign up for an account">
    Visit [odds-api.io](https://odds-api.io) and create a free account.
  </Step>
  <Step title="Access your dashboard">
    Once logged in, navigate to your dashboard to find your API key.
  </Step>
  <Step title="Copy your API key">
    Your API key will be visible in the dashboard. Keep it secure!
  </Step>
</Steps>
...
```bash cURL
curl "https://api.odds-api.io/v3/odds?apiKey=YOUR_API_KEY&eventId=123456&bookmakers=Bet365,Unibet,Pinnacle"
```
