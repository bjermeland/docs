...
description: 'Odds-API.io API reference. Access real-time betting odds from 250+ bookmakers, 100+ market types, value bets, and WebSocket feeds.'
---
...
```bash
curl "https://api2.odds-api.io/v3/events?apiKey=YOUR_KEY&sport=football&limit=10"
```
</Tab>

<Tab title="Get Odds">
```bash
curl "https://api2.odds-api.io/v3/odds?apiKey=YOUR_KEY&eventId=123456&bookmakers=Bet365,Unibet"
```
</Tab>

<Tab title="Find Value Bets">
```bash
curl "https://api2.odds-api.io/v3/value-bets?apiKey=YOUR_KEY&bookmaker=Bet365&includeEventDetails=true"
```
</Tab>
</Tabs>
